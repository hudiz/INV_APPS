<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"  EnableEventValidation="false" CodeFile="Purchase_Rep.aspx.vb" Inherits="Report_Purchase_Rep" %>
        ...
        <div class="expensedtls">
            ...
            <table class="sales_tab">
                ...
                <asp:GridView CssClass="table table-bordered table-hover table-condensed table-striped"
                    ...
                    <Columns>
                        <asp:BoundField DataField="pr_guid" HeaderText="GID" ItemStyle-Width="80px"
                            ReadOnly="True" SortExpression="pr_guid" Visible="false">
                            <ItemStyle Width="40px"></ItemStyle>                           
                        </asp:BoundField>
                <asp:HyperLinkField DataNavigateUrlFields="pr_inv_id" HeaderText="INVOICE NO"
                    ControlStyle-Width="80px" DataNavigateUrlFormatString="Purchase_Details_Rep.aspx?invno={0}"
                    Target="_blank" DataTextField="pr_inv_id" />
                        <%--<asp:BoundField DataField="pr_inv_id" HeaderText="INVOICE NO" ItemStyle-Width="100px"
                            SortExpression="pr_inv_id">
                            <ItemStyle Width="100px"></ItemStyle>
                        </asp:BoundField>--%>
                        <asp:BoundField DataField="pr_date_time" HeaderText="DATE" ItemStyle-Width="80px"
                            SortExpression="pr_date_time" DataFormatString="{0:d}" FooterText="Count:">
                            <ItemStyle Width="80px"></ItemStyle>
                            <FooterStyle  Width="80px" HorizontalAlign="Right"></FooterStyle> 
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_cust_id" HeaderText="CUSTOMER ID" ItemStyle-Width="80px"
                            SortExpression="rcpt_typ">
                            <ItemStyle Width="80px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_cust_name" HeaderText="CUSTOMER NAME" ItemStyle-Width="200px"
                            SortExpression="rcpt_ref_id" FooterText="Total:">
                            <ItemStyle Width="200px"></ItemStyle>
                            <FooterStyle    HorizontalAlign="Right"></FooterStyle>                            
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_tot_amt" HeaderText="AMOUNT" ItemStyle-Width="80px"
                            SortExpression="rcpt_frm_typ">
                            <ItemStyle Width="80px" HorizontalAlign="Right"></ItemStyle>
                            <FooterStyle  Width="80px" HorizontalAlign="Right"></FooterStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_disc" HeaderText="DISCOUNT" ItemStyle-Width="80px"
                            SortExpression="rcpt_frm_acc">
                            <ItemStyle Width="80px" HorizontalAlign="Right"></ItemStyle>
                            <FooterStyle  Width="80px" HorizontalAlign="Right"></FooterStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_tax_amt" HeaderText="TAX" ItemStyle-Width="80px"
                            SortExpression="pr_tax_amt">
                            <ItemStyle Width="80px" HorizontalAlign="Right"></ItemStyle>
                            <FooterStyle  Width="80px" HorizontalAlign="Right"></FooterStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_oth_amt" HeaderText="OTHER" ItemStyle-Width="80px"
                            SortExpression="pr_oth_amt">
                            <ItemStyle Width="80px" HorizontalAlign="Right"></ItemStyle>
                            <FooterStyle  Width="80px" HorizontalAlign="Right"></FooterStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_net_amt" HeaderText="NETT" ItemStyle-Width="80px"
                            SortExpression="pr_net_amt">
                            <ItemStyle Width="80px" HorizontalAlign="Right"></ItemStyle>
                            <FooterStyle  Width="80px" HorizontalAlign="Right"></FooterStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_remark" HeaderText="REMARK" ItemStyle-Width="200px"
                            SortExpression="pr_remark">
                            <ItemStyle Width="200px"></ItemStyle>
                        </asp:BoundField>
                       <%-- <asp:BoundField DataField="pr_paid_by1" HeaderText="PAID BY[1]" ItemStyle-Width="80px"
                            SortExpression="pr_paid_by1">
                            <ItemStyle Width="80px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_amt1" HeaderText="AMT[1]" ItemStyle-Width="80px"
                            SortExpression="pr_amt1">
                            <ItemStyle Width="80px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_rmk1" HeaderText="RMK[1]" ItemStyle-Width="80px"
                            SortExpression="pr_rmk1">
                            <ItemStyle Width="80px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_paid_by2" HeaderText="PAID BY[2]" ItemStyle-Width="80px"
                            SortExpression="pr_paid_by2">
                            <ItemStyle Width="80px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_amt2" HeaderText="AMT[2]" ItemStyle-Width="80px"
                            SortExpression="pr_amt2">
                            <ItemStyle Width="80px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_rmk2" HeaderText="RMK[2]" ItemStyle-Width="80px"
                            SortExpression="pr_rmk2">
                            <ItemStyle Width="80px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_crd_flg" HeaderText="CREDIT" ItemStyle-Width="80px"
                            SortExpression="pr_crd_flg">
                            <ItemStyle Width="80px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="pr_cr_amt" HeaderText="CR AMT" ItemStyle-Width="80px"
                            SortExpression="pr_cr_amt">
                            <ItemStyle Width="80px"></ItemStyle>
                        </asp:BoundField>--%>
                       <%-- <asp:TemplateField>
                            <ItemTemplate>
