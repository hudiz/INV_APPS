...
Partial Class Report_Sales_Rep
    Inherits System.Web.UI.Page
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Not IsPostBack And Not IsCallback Then
            Session("SALESREP_gv_Sales_rep") = Nothing
    ...
    Public Sub load_Customer_details()
        Dim qry As String = "SELECT  cust_sup_id ID, cust_sup_id + ' - ' + cust_sup_name as NAME FROM cust_supp_dtls where cust_sup_sts = 'C' "
    ...
    Public Sub load_report_grid()
        ...
        Dim qry As String = "SELECT * FROM [sr_dtls] Where sr_cust_id like '" + dd_custid.SelectedValue + "' " +
                            " and  createon between '" + fromdt.ToString("MM/dd/yyyy HH:mm:ss") + "' and  '" + todt.AddDays(1).AddSeconds(-1).ToString("MM/dd/yyyy HH:mm:ss") + "'   " +
                            " and ( sr_remark like '" + srch + "'  or sr_inv_id like '" + srch + "' " +
                            "  or sr_rmk1 like '" + srch + "'  or sr_rmk2 like '" + srch + "'   )"
        Dim dt As DataTable = ConfigData.getDataToDatatable(qry)
        Session("SALESREP_gv_Sales_rep") = dt
    ...
    Private Sub gv_Sales_rep_Load(sender As Object, e As EventArgs) Handles gv_Sales_rep.Load
        Dim dt As DataTable = TryCast(Session("SALESREP_gv_Sales_rep"), DataTable)
        gv_Sales_rep.DataSource = dt
        gv_Sales_rep.DataBind()
    End Sub
    ...
    Protected Sub ExportToExcel(sender As Object, e As EventArgs)
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Sale_Rep.xls")
        Response.Charset = ""
