<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"  EnableEventValidation="false"
     CodeFile="Supplier_details.aspx.vb" Inherits="Supplier_Supplier_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="col-lg-5 col-md-5 col-sm-12">
        <div class="accountInfo">
            ...
            <asp:Label ID="custgid" runat="server" Text="" Visible="false" 
            ForeColor="White" BackColor="Black" 
            style="float:right; padding: 2px;border-radius: 5px;margin-top: -10px;"
             Font-Bold="true"></asp:Label>
           <%--  <div> 
                    <asp:Label ID="compidLabel" runat="server" AssociatedControlID="compid">Company</asp:Label>
                    <table>
                        <tr>
                            <td>
                ...
                <%--<asp:HiddenField ID="custgid" runat="server" Visible="true" />--%>
                    <asp:Label ID="custidLabel" runat="server" AssociatedControlID="custid">Supplier ID:</asp:Label>
                    <table>
                        <tr>
                            <td>
                ...
                <div>
                    <asp:Label ID="custnameLabel" runat="server" AssociatedControlID="custname">Supplier Name:</asp:Label>
                    <table>
                        <tr>
                            <td>
        ...
        <div class="accountdtls">
            <div class="table-responsive">
                <asp:GridView CssClass="table table-bordered table-hover table-condensed table-striped"
                    ID="gv_cust" runat="server" AutoGenerateColumns="False"
